...
namespace {
	...
	// Freemius SDK removed — Pro is unlocked for everyone, no licensing layer.
...
namespace Upress\EzCache {
	...
	add_action( 'plugins_loaded', function() { \Upress\EzCache\PremiumFeatures::maybe_start_trial(); }, 20 );
}
